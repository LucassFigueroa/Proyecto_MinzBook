  ...
  return (
    <div className="container container-narrow py-3">
      ...
      <div className="d-flex gap-2 mt-3">
        <Link to="/catalog" className="btn btn-outline-success fw-bold seguir-comprando-btn">
          Seguir comprando
        </Link>
        <button className="btn btn-success fw-bold ir-a-pagar-btn">Ir a pagar</button>
      </div>
